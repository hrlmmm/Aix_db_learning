...
class SysCodeEnum(Enum):
    ...
    每个枚举值是一个元组：(错误码, 中文消息, 英文消息)
    """
    c_200 = (200, "ok", "ok")
    c_401 = (401, "登录异常", "login exception")
    c_400 = (400, "无效Token", "invalid token")
    c_9999 = (9999, "系统异常", "system exception")

    # 业务相关状态码(错误码, 中文消息, 英文消息)
    SUCCESS = (200, "成功", "success")
    PARAM_ERROR = (400, "参数错误", "parameter error")
    DATA_NOT_FOUND = (404, "数据不存在", "data not found error")
